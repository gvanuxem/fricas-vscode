...
const profilerContextKey = 'fricas.profilerFocus'
export class ProfilerFeature {
    ...
    constructor(context: vscode.ExtensionContext) {
        ...
        this.context.subscriptions.push(
            registerCommand('language-fricas.openProfiler', () => {
                this.show()
            }),
            registerCommand('language-fricas.nextProfile', () => {
                this.next()
            }),
            registerCommand('language-fricas.previousProfile', () => {
                this.previous()
            }),
            registerCommand('language-fricas.deleteProfile', () => {
                this.delete()
            }),
            registerCommand('language-fricas.deleteAllProfiles', () => {
                this.deleteAll()
            }),
            registerCommand('language-fricas.saveProfileToFile', () => {
                this.saveToFile()
            }),
    ...
    inlineTraceColor(highlight: InlineTraceElement | number) {
        ...
        if (flags & 0x01) {
            return new vscode.ThemeColor('fricas.profiler.dispatch')
        }
        if (flags & 0x02) {
            return new vscode.ThemeColor('fricas.profiler.gc')
        }
        return new vscode.ThemeColor('fricas.profiler.default')
    }
