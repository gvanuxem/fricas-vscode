...
/**
 * This interface describes the FriCAS specific launch attributes
 * (which are not part of the Debug Adapter Protocol).
 * The schema for these attributes lives in the package.json of the FriCAS extension.
...
export class FriCASDebugSession extends LoggingDebugSession {
     ...
     */
    public constructor(private context: vscode.ExtensionContext, private fricasExecutable: FriCASExecutable) {
        super('fricas-debug.txt')
    ...
    protected async attachRequest(response: DebugProtocol.AttachResponse, args: AttachRequestArguments) {
        ...
        const pn = generatePipeName(v4(), 'vsc-jl-dbg')
    ...
    protected async launchRequest(response: DebugProtocol.LaunchResponse, args: LaunchRequestArguments) {
        ...
        const task = new vscode.Task(
            ...
            new vscode.ProcessExecution(this.fricasExecutable.file, jlargs, {
                env: env,
                cwd: args.cwd,
            })
        )
